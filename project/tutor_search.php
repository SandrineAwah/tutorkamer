...
<select class="form-control" name="subject" id="subject" placeholder="Enter the subject for your tutor">
  ...
  <option value="HigherMath">Futher math</option>
  <option value="Accounting">History</option>
  <option value="Finance">Geography</option>
  <option value="Marketing">Civics</option> 
  <option value="python">Programming in python</option>
  <option value="java">programming in java</option>
  <option value="frontend">web development with python</option>
  <option value="GCE revision">GCE ol/Advance level Revision Teacher</option>
  <option value="class one">Primary one teacher</option>
  <option value="class one to six">primary school tutor for all subject</optiotion><br><br> 
